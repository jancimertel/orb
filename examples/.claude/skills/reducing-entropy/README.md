...
- Original skill from [softaworks/agent-toolkit](https://github.com/softaworks/agent-toolkit) (reducing-entropy); originally by [joshuadavidthomas/agent-skills](https://github.com/joshuadavidthomas/agent-skills) (MIT)
